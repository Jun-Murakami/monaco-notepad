...
<img width="1277" height="747" alt="スクリーンショット" src="https://github.com/user-attachments/assets/d4299a17-28f6-4d3f-89e0-b6538d12a33b" />
...
📱 **インストール** — デスクトップ版の **設定 → モバイル版アプリ** ダイアログから iOS / Android の QR コードをスキャンするか、ストアで「Monaco Notepad」を検索してください。Google Play のパッケージ名は [`dev.junmurakami.monaconotepad`](https://play.google.com/store/apps/details?id=dev.junmurakami.monaconotepad)。
