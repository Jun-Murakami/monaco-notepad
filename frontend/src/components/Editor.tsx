...
import { DEFAULT_EDITOR_FONT_FAMILY, type FileNote, type Note, type Settings } from '../types';
    ...
    <Box
      sx={{
        ...
        '& .monaco-editor .unicode-highlight': {
          border: settings.isDarkMode ? '1px solid rgba(255, 214, 102, 0.05)' : '1px solid rgba(255, 193, 7, 0.05)',
          backgroundColor: settings.isDarkMode ? 'rgba(255, 214, 102, 0.03)' : 'rgba(255, 193, 7, 0.03)',
