...
describe('MessageDialog', () => {
  ...
  it('ツーボタンモードで、両方のボタンが表示されること', () => {
    render(<MessageDialog {...defaultProps} isOpen={true} isTwoButton={true} />);
  ...
  it('カスタムボタンテキストが正しく表示されること', () => {
    render(
      <MessageDialog {...defaultProps} isOpen={true} isTwoButton={true} primaryButtonText='はい' secondaryButtonText='いいえ' />
    );
  ...
  it('Cancelボタンクリック時にonResultがfalseで呼ばれること', () => {
    ...
    fireEvent.click(screen.getByRole('button', { name: defaultProps.secondaryButtonText }));
