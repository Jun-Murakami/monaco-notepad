...
describe('useEditorSettings フック', () => {
  ...
  describe('初期化処理', () => {
    it('設定が正常に読み込まれること', async () => {
      ...
      expect(runtime.WindowSetPosition).toHaveBeenCalledWith(mockSettings.windowX, mockSettings.windowY);
      expect(runtime.WindowSetSize).toHaveBeenCalledWith(mockSettings.windowWidth, mockSettings.windowHeight);
