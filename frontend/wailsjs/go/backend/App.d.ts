...
export function ApplyIntegrityFixes(
  arg1: Array<backend.IntegrityFixSelection>,
): Promise<backend.IntegrityRepairSummary>;
...
export function GetArchivedTopLevelOrder(): Promise<
  Array<backend.TopLevelItem>
>;
...
export function UpdateArchivedTopLevelOrder(
  arg1: Array<backend.TopLevelItem>,
): Promise<void>;
...
export function UpdateTopLevelOrder(
  arg1: Array<backend.TopLevelItem>,
): Promise<void>;
