...
export function CreateNote(arg1:backend.Note):Promise<void>;
...
export function QueueNoteOperation(arg1:backend.UpdateOperation):Promise<void>;

export function ReorderNotes(arg1:Array<backend.Note>):Promise<void>;
...
export function UpdateNote(arg1:backend.Note):Promise<void>;
